...
$lang['if_smtp_authentication']  = '使用SMTP協議發送的郵件地址，如 shopnc.club@163.com';
$lang['smtp_user_name']          = 'SMTP 身份驗證用戶名';
$lang['smtp_user_name_tip']      = '如 shopnc.club';
$lang['smtp_user_pwd']           = 'SMTP 身份驗證密碼';
$lang['smtp_user_pwd_tip']       = 'shopnc.club@163.com郵件的密碼，如 123456';
...
$lang['ucenter_application_id_tips'] 	= '运维舫商城系統在待整合中的應用ID';
...
$lang['ftp_attach_dir_tip'] 	= '遠程附件目錄的絶對路徑或相對於 FTP 主目錄的相對路徑，如果是根目錄請填"/"，非根目錄，請保證伺服器端該目錄已存在，結尾不需要"/"，如"/upload/club"';
$lang['ftp_access_url_tip'] = '支持 HTTP 和 FTP 協議，結尾不要加斜杠“/”；如果使用 FTP 協議，FTP 伺服器必需支持 PASV 模式，為了安全起見，使用 FTP 連接的帳號不要設置可寫權限和列表權限。如果是根目錄，直接輸入域名即可，如“http://www.shopnc.club”，如果非根目錄，需要填寫域名+目錄形式，如“http://www.shopnc.club/upload/club”';
