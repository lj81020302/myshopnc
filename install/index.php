...
<div class="header">
  <div class="layout">
    ...
    <div class="version">版本: 2016.12.15</div>
  </div>
</div>
...
function step3(&$install_error,&$install_recover){
    ...
    if ($_POST['demo_data'] == '1'){
        $db->query("UPDATE {$db_prefix}store SET `store_name`='运维舫',`store_address`='中国',`store_phone`='400-80000000',`store_address`='北京' WHERE `store_id`=1");
