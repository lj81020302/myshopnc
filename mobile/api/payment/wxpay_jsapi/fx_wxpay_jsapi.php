...
class fx_wxpay_jsapi
{
    ...
    public function __construct()
    {
        $this->config = (object) array(
            ...
            'notifyUrl' => MOBILE_SITE_URL . '/api/payment/wxpay_jsapi/fx_notify_url.php',
            'finishedUrl' => WAP_SITE_URL . '/tmpl/fx_member/payment_result.html?_=2&attach=_attach_',
            'undoneUrl' => WAP_SITE_URL . '/tmpl/fx_member/payment_result_failed.html?_=2&attach=_attach_',
