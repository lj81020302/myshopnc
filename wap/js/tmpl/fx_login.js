$(function(){
	...
	$('.weibo').click(function(){
	    location.href = ApiUrl+'/index.php?act=fx_connect&op=get_sina_oauth2';
	})
    $('.qq').click(function(){
        location.href = ApiUrl+'/index.php?act=fx_connect&op=get_qq_oauth2';
    })
    $('.wx').click(function(){
        location.href = ApiUrl+'/index.php?act=fx_connect&op=index';
    })
});