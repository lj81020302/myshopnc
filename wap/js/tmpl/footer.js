$(function (){
    ...
    if(key){
        ...
        html += '<a href="javascript:void(0);" class="gotop">返回顶部</a>' + "</div>" + '<!--<div class="copyright">' + 'Copyright&nbsp;&copy;&nbsp;2005-2016 <a href="javascript:void(0);">运维舫S7 www.shopnc.club</a>版权所有' + "</div>--></div>";
