    ...
    public function show($style = null){
        ...
        switch ($this->style) {
            ...
            case '6':
                ...
                $html_page .= '<ul>';
                if ($this->getNowPage() <= 1){
                    $html_page .= '<li class="active"><a href="#">首页</a></li>';
                    $html_page .= '<li class="active"><a href="#">末页</a></li>';
                }else {
                    $html_page .= '<li><a href="'. $this->page_url . 1 .'">首页</a></li>';
                    $html_page .= '<li><a href="'. $this->page_url . ($this->getNowPage()-1) .'">上一页</a></li>';
                }
                $html_page .= $this->getNowBar();
                if ($this->getNowPage() == $this->getTotalPage() || $this->getTotalPage() == 0){
                    $html_page .= '<li class="active"><a href="#">下一页</a></li>';
                    $html_page .= '<li class="active"><a href="#">末页</a></li>';
                }else {
                    $html_page .= '<li><a href="'. $this->page_url . ($this->getNowPage()+1) .'">下一页</a></li>';
                    $html_page .= '<li><a href="'. $this->page_url . ($this->getTotalPage()) .'">末页</a></li>';
                }
                $html_page .= '</ul>';
                break;
            default:
