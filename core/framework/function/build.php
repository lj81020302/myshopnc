...
//	}
	...
	$compile .= "\nBase::run();";
	file_put_contents(RUNCOREPATH,compress_code("<?php defined('ShopNC_CLUB') or exit('Access Invalid!');".$compile));
}
...
function compile($filename) {
    ...
    $content = str_ireplace("defined('ShopNC_CLUB') or exit('Access Invalid!')", '', $content);
